...
{
			//front right
		mydata.neuron[4].gates=0;//(rand()%10);
		//front leftt
		mydata.neuron[5].gates=0;//(rand()%10);
		//back right
		mydata.neuron[6].gates=0;//(rand()%10)+30;
		//back left
		mydata.neuron[7].gates=0;//(rand()%10);

		//front center
		mydata.neuron[8].gates=0;//(rand()%10);
		//back center
		mydata.neuron[9].gates=0;//(rand()%10)+10;
