...
----------------------------------------------------------------------		
		...
		{
			mydata.neuron[2].gates=mydata.neuron[2].gates+225;
			mydata.neuron[3].kgates=mydata.neuron[3].kgates+60;
		}
		...
		{
			mydata.neuron[2].kgates=mydata.neuron[2].kgates+60;
			mydata.neuron[3].gates=mydata.neuron[3].gates+225;
		}
...
------------------------------------------------------------------------
	...
	{
		if(speeda<235) {speeda=speeda+10;}
	}
	...
	{
		if(speedb<235) {speedb=speedb+10;}
	}
