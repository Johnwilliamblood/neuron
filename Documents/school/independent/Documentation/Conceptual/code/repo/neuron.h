...
----------------------------------------------------------------------		
		...
		{
			mydata.neuron[2].gates=mydata.neuron[2].gates+160;
		...
		if (mydata.neuron[5].fire==1)
		{
			...
			mydata.neuron[3].gates=mydata.neuron[3].gates+160;
		}
...
------------------------------------------------------------------------------------
		...
		{
			mydata.neuron[0].gates=mydata.neuron[0].gates+60;
		...
		{
			mydata.neuron[1].gates=mydata.neuron[1].gates+60;
